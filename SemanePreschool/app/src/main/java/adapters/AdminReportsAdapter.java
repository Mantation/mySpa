...
public class AdminReportsAdapter extends RecyclerView.Adapter <AdminreportViewHolder>{
    ...
    public AdminReportsAdapter(Activity activity, Context context) {
    ...
    String year = "";
    @Override
    public void onBindViewHolder(@NonNull final AdminreportViewHolder holder, int position) {
        ...
        if(Total>50){
            ...
            holder.body.setText(ID[position]+"\n" + f.format(Total) +"% : Pass \n"+grade);
            PassFail="pass";
        }else{
