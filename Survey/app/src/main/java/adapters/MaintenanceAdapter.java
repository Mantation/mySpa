...
public class MaintenanceAdapter extends RecyclerView.Adapter <taskViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final @NonNull taskViewHolder holder, int position) {
        ...
        holder.MainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //start.setDocumentId(DocumentRef[position]);
                if(doubleClicked){
                    doubleClicked = false;
                    //start.setMyImage(Image[position]);
                    start.setDocumentId(DocumentRef[position]);
                    methods.globalMethods.loadFragments(R.id.main, new start(), activity);
                }
                doubleClicked = true;
                activity.runOnUiThread(new Runnable() {
                    public void run() {
                Toast.makeText(activity, "double click to close this issue or press and hold to change status", Toast.LENGTH_SHORT).show();
                    }
                });
