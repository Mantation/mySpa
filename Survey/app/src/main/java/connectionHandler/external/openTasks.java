...
public class openTasks extends Application {
    ...
    static MaintenanceAdapter maintenanceAdapter;
    /*Relevant-Knowledge
...
[Content]
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            maintenanceAdapter = new MaintenanceAdapter(activity);
                            maintenanceAdapter.setImage(MyImage);
                            maintenanceAdapter.setDate(Mydate);
                            maintenanceAdapter.setTime(Mytime);
                            maintenanceAdapter.setStatus(MyStatus);
                            maintenanceAdapter.setDocumentRef(MyDocRef);
                            maintenanceAdapter.setDescription(MyDescription);
                            maintenanceAdapter.setPauses(MyPause);
    ...
    private static  void getFirestoreOpenedTasks(final Activity activity, final RecyclerView recyclerView, final TextView textView){
        ...
        db.collection(constants.maintenance).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        dbs.collection(constants.maintenance)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
